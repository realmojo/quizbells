    ...
    <main className="mx-auto max-w-[720px] px-4 py-8 mb-20">
      ...
      <section className="mt-8 space-y-6">
        ...
        <section>
          ...
          <p>
            본 약관은 퀴즈벨(이하 "회사")이 제공하는 퀴즈 정답 알림 서비스(이하
            "서비스")의 이용과 관련하여 회사와 사용자 간의 권리, 의무 및
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              "서비스"란 회사가 운영하는 웹사이트 및 모바일 앱을 통해 퀴즈 정답
              및 알림 정보를 제공하는 행위를 의미합니다.
            </li>
            <li>
              "사용자"란 본 약관에 따라 서비스를 이용하는 개인 또는 법인을
              의미합니다.
            </li>
          </ul>
        </section>
        <section>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              회사는 사용자에게 퀴즈 정답, 푸시 알림, 퀴즈 검색 및 기록 기능
              등을 제공합니다.
            </li>
            <li>
              서비스는 기본적으로 무료로 제공되며, 일부 기능에 대해 광고가
              포함될 수 있습니다.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            손해 등에 대해 법적 책임을 지지 않습니다. 단, 서비스의 안정적인
            제공을 위해 최선을 다합니다.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            회사는 관련 법령의 변경이나 서비스 개선을 위해 약관을 수정할 수
