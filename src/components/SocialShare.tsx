  ...
  return (
    <div className="flex flex-col items-center space-y-4 pb-8">
      ...
      <div className="flex justify-center items-center space-x-4">
        ...
        <button onClick={shareFacebook} className="hover:scale-105 transition-transform">
          <Image
        ...
        <button id="kakao-link-btn" className="hover:scale-105 transition-transform">
          <Image
        ...
        <button onClick={copy} className="hover:scale-105 transition-transform">
          <Image
            src="/images/link.png"
            alt="link-share-icon"
            width={50}
